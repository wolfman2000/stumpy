...
describe( 'A dungeon with no chests of randomized items and no entrance lock', () => {
  ...
  beforeEach( () => { dungeon = new Dungeon(Location.SkullWoods, 'random location', 'random name', Reward.Unknown, 0); });
...
describe( 'A dungeon with two items inside', () => {
  ...
  beforeEach( () => { dungeon = new Dungeon(Location.TowerOfHera, 'random location', 'random name', Reward.Unknown, 2); });
...
describe( 'A dungeon with a medallion lock', () => {
  ...
  beforeEach( () => {
    dungeon = new Dungeon(Location.TurtleRock, 'random location', 'random name', Reward.Unknown, 0, EntranceLock.Unknown);
  });
